export interface AppAiServiceAPI {
  global: {
    title: string
    api: {
...
export interface AppMyBricksAIService {
  api: AppAiServiceAPI | null
  focus: AppAiServiceFocusParams | null | undefined
  isReady: () => boolean
  ready: () => Promise<AppMyBricksAIService>
}